...
/// Each load owns verified bytes. Deleting the book cannot invalidate an
/// active lease; new loads after deletion fail. No URL, online cache or
/// network access. Media from other sources has no backing implementation
/// and fails explicitly (legacy shelf snapshots only keep the ref).
class LocalImageRepository implements ImageRepository {
  LocalImageRepository({required this.local});
