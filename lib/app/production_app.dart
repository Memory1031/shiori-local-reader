...
/// Process root owns the databases and local repositories. Startup performs
/// no network I/O; this build contains no online source services.
...
class _ProductionAppState extends State<ProductionApp> {
  ...
  Future<void> _open() async {
    ...
    try {
      ...
      _novels = LocalReadingRepository(local: databases.localBooks);
      _images = LocalImageRepository(local: databases.localBooks);
  ...
  @override
  Widget build(BuildContext context) => _novels == null
      ? ShioriApp(
          routes: AppRoutes(
