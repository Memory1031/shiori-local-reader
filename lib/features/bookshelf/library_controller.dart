...
class LibraryController extends ScopedController {
  LibraryController(this.repository, {this.localBooks});
  ...
  Future<bool> remove(NovelKey key) {
    ...
    // Legacy entries from builds with online sources only leave the shelf;
    // reading history is kept, as with those builds' removal flow.
    return _write(
