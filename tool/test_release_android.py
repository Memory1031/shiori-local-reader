...
class ReleaseChecksTest(unittest.TestCase):
    ...
    def test_apk_identity_debug_flag_and_certificate(self):
        badging = "package: name='dev.shiori.localreader' versionCode='2' versionName='1.0.0' platformBuildVersionName='16'\n"
        certificate = 'a' * 64
        ...
        for output, signatures, expected in [
            ...
            (badging.replace('dev.shiori.localreader', 'other.app'), certs, certificate),
