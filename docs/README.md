...
文档只维护当前行为、支持边界和发布操作。开发过程与已完成任务查 Git 历史。

| 文档 | 用途 |
| --- | --- |
| [开发说明](development.md) | 工具链、运行、测试和排障 |
| [架构与数据规则](architecture.md) | 领域身份、应用装配、数据库和本地资源 |
...
| [版本说明](release/notes/v1.0.1.md) | 当前与历史版本发布说明 |
